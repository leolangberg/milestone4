...
module datapath (
	input clk,
	input rst_n,
	output rf_data_out_1,
	output rf_data_out_2,
	output alu_out
...
always_comb begin
	...
	alu_opcode = {rtype_func3, rtype_func7[5]}; 

	rf_data_in = alu_out;
	
	// Controll signals for RTYPE:
	rf_write_en_n 	= '0;	// write yes
	rf_chip_en		= '1;	// read/write yes	
	sram_read_en	= '1;
